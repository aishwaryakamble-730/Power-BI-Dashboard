...
- Category-wise and yearly analysis using waterfall charts  
- Location-based hierarchy for multi-level sales insights  
- Region-wise profit drill-through reporting  
- Finance dashboard with KPIs, navigation, slicers, and interactive layouts  
...
- KPI logic for financial and sales metrics  
...
- Page navigation buttons and linked visuals  
...
- Bookmarks, Drill-through, Conditional Formatting  
